...
void DisplayJoinRequestUpdate( LmHandlerJoinParams_t *params )
{
    if( params->CommissioningParams->IsOtaaActivation == true )
    {
        if( params->Status == LORAMAC_HANDLER_SUCCESS )
        {
            printf( "###### ===========   JOINED     ============ ######\n" );
            printf( "\nOTAA\n\n" );
            printf( "DevAddr     :  %08lX\n", (unsigned long) params->CommissioningParams->DevAddr );
            printf( "\n\n" );
...
void DisplayTxUpdate( LmHandlerTxParams_t *params )
{
    ...
    printf( "\n###### =====   UPLINK FRAME %8lu   ===== ######\n", (unsigned long) params->UplinkCounter );
    printf( "\n" );
    ...
    {
        printf( "U/L FREQ    : %lu\n", (unsigned long) mibGet.Param.ChannelList[params->Channel].Frequency );
    }
...
void DisplayRxUpdate( LmHandlerAppData_t *appData, LmHandlerRxParams_t *params )
{
    ...
    printf( "\n###### =====  DOWNLINK FRAME %8lu  ===== ######\n", (unsigned long) params->DownlinkCounter );
